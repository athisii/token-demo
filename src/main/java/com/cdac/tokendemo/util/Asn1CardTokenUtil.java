package com.cdac.tokendemo.util;


import com.cdac.tokendemo.App;
import com.cdac.tokendemo.api.LocalNavalWebServiceApi;
import com.cdac.tokendemo.dto.*;
...
import static com.cdac.tokendemo.constant.ApplicationConstant.GENERIC_ERR_MSG;
...
public class Asn1CardTokenUtil {
    ...
    static {
        MANTRA_CARD_READER_NAME = App.getReaderCard();
        MANTRA_CARD_WRITER_NAME = App.getReaderToken();
        CARD_API_SERVICE_RESTART_COMMAND = App.getCardApiServiceRestartCommand();
    }
